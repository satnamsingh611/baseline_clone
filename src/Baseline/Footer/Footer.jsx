                    ...
                    <div className="sub-footer-main">
                        ...
                        <div className="row footer-clint-read-more">
                            <div className="col-md-6 baseline-development">
                                <div className="contant-box">
                                    <div className="read-more expanded" >
                                        ...
                                        <span className="trigger" style={{ cursor: "pointer" }} onClick={() => setRead(!read)}>{!read ? <p style={{ color: "#2980b9" }}>+ read more</p> : <p style={{ color: "blue" }}>+ thank you for read</p>}</span>
                                    </div>
                                </div>
                                <div className="arrow">
                                ...
                                <div className="contant-box" id="readmore">
                                    <div className="read-more expanded">
                                        ...
                                        <span className="trigger" onClick={() => setRead1(!read1)}
                                            style={{ cursor: "pointer" }}>{!read1 ? <p style={{ color: "#2980b9" }}>+ read more</p> : <p style={{ color: "blue" }}>+ thank you for read</p>}</span>
                                    </div>
                            ...
                            <motion.div
                                ...
                                transition={{ duration: 1 }}
                            >
                                <h2 className="aos-init aos-animate">Read more<span style={{ color: "#bb372a" }}> about Blog</span></h2>
                            </motion.div>
                        </div>
