        ...
        <div className="baseline-our-process">
          <div className="baseline-our-process__heading-highlight" >
            <motion.div
              ...
              <h2 style={{ fontSize: "50px", fontWeight: "700" }} className=" aos-animate">Our <span style={{ color: "#bb372a" }}>Process</span></h2>
            </motion.div>
          </div>
          <OurProcess
          ...
          />
          <OurProcess
            icons={<i className="fa-solid fa-pen-to-square" style={{ fontSize: "55px", marginTop: "10px" }}></i>}
            heading="DESIGN"
            ...
            icons1={<i className="fa-solid fa-code" style={{ fontSize: "55px", marginTop: "10px" }}></i>}
          ...
          />
          <OurProcess
            icons={<i className="fa-brands fa-searchengin" style={{ fontSize: "55px", marginTop: "10px" }}></i>}
            heading="TESTING"
            ...
            icons1={<i className="fa-sharp fa-solid fa-paper-plane" style={{ fontSize: "55px", marginTop: "10px" }}></i>}
            heading1="LAUNCH"
                ...
                <div className="row">
                  <div className="col-md-5 steps">
                    <div className="process-step">
                      <i className="fa-solid fa-gears" style={{ fontSize: "55px", marginTop: "10px" }}></i>
                    </div>
                  </div>
